...
### 1.&nbsp; Install a C++ compiler, Meson, GoogleTest, and [system_state](https://github.com/cshmookler/system_state).

#### Linux (MOOS):

```bash
sudo pacman -S base-devel git meson gtest moos-system-state
```
